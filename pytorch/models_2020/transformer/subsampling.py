...
class Conv2dSubsampling(torch.nn.Module):
    ...
    def __init__(self, idim, odim, dropout_rate):
        ...
        self.conv = torch.nn.Sequential(
            torch.nn.Conv2d(1, odim, 3, 2), torch.nn.ReLU(), torch.nn.Conv2d(odim, odim, 3, 2), torch.nn.ReLU()
        )
...
class Conv2dNoSubsampling(torch.nn.Module):
    ...
    def __init__(self, idim, odim, dropout_rate):
        ...
        self.conv = torch.nn.Sequential(
            torch.nn.Conv2d(1, odim, 3, 1, 1), torch.nn.ReLU(), torch.nn.Conv2d(odim, odim, 3, 1, 1), torch.nn.ReLU()
        )
        self.out = torch.nn.Sequential(torch.nn.Linear(odim * idim, odim), PositionalEncoding(odim, dropout_rate))
